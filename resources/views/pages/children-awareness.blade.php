    ...
    <section class="relative py-24 lg:py-32 overflow-hidden" style="background: #fafaf5;">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-x-8 gap-y-3 text-sm">
                <a href="{{ $donateUrl }}" class="inline-flex items-center gap-2 text-deep-green font-bold underline decoration-vibrant-lime decoration-2 underline-offset-4 hover:decoration-[3px] transition-all">
