            ...
            <article id="event-{{ $featured->id }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 md:p-8 lg:p-10 flex flex-col">
                        ...
                        <a href="{{ route('upcoming-events.show', $featured) }}"
                            class="inline-flex items-center gap-1.5 text-deep-green text-xs font-extrabold tracking-[0.2em] uppercase border-b-2 border-vibrant-lime/50 hover:border-vibrant-lime hover:gap-2.5 pb-1 mb-6 transition-all w-fit">
